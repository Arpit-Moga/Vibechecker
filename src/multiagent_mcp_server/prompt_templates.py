# Prompt templates for all agent types, parameterized for dynamic assembly

DEBT_PROMPT_TEMPLATE = """You are a senior code reviewer specializing in technical debt analysis. Analyze this code for technical debt issues that impact maintainability, scalability, and future development velocity.
...
CRITICAL_PROMPT_TEMPLATE = """You are a senior security and reliability engineer specializing in critical issue detection. Analyze this code for critical security vulnerabilities, data safety issues, and reliability problems that could cause serious harm.
...
IMPROVEMENT_PROMPT_TEMPLATE = """You are an expert code reviewer specializing in identifying improvement opportunities. Analyze this code for areas where quality, performance, maintainability, or best practices could be enhanced.
